...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.host')),
        ...
        migrations.AddField(
            model_name='host',
            name='host',
            field=models.ManyToManyField(through='accounts.UserHost', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
